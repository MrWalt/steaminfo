  ...
  return (
    <div className="col-start-1 col-end-4 bg-primary-600 flex gap-4 py-4 px-4 rounded-layout border border-primary-400 relative h-full">
      ...
      >
        ...
        <span className="absolute text-xl text-primary-50 top-[50%] right-[50%] translate-x-[50%] translate-y-[50%] view-image-text font-bold text-outline bg-primary-700 px-2 py-1 rounded-sm border border-primary-400">
          View
        </span>
      </div>
